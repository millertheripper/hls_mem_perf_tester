...
add_files hls_mem_perf_tester.cpp
add_files hls_mem_perf_tester.hpp
add_files -tb hls_mem_perf_tester_tb.cpp -cflags "-Wno-unknown-pragmas" -csimflags "-Wno-unknown-pragmas"
